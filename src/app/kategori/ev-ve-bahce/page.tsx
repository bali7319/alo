// ev-ve-bahce klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Ev & Bahçe';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'ev-ve-bahce' }, { category: 'Ev & Bahçe' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/ev-ve-bahce`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/ev-ve-bahce`,
    },
  };
}

export default async function EvVeBahcePage() {
  const slug = 'ev-ve-bahce';
