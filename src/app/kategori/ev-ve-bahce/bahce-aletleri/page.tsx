...
export default function BahceAletleriPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'bahce-aletleri')
    if (!foundSubcategory) return
    setSubcategory(foundSubcategory)

    const bahceAletleriListings: Listing[] = rawListings
      .filter(listing => 
        listing.category.toLowerCase() === 'ev-ve-bahce' && 
        (listing.subCategory?.toLowerCase() ?? '') === 'bahce-aletleri'
      )
    setMappedListings(bahceAletleriListings)
  }, [])
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Bahçe Aletleri Kategorileri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Profesyonel bahçe aletleri ve ekipmanları
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Bahçe Aletleri İlanları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Bahçe Aletleri İlanları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
