...
export default function KitaplikPage() {
  ...
  useEffect(() => {
    ...
    const foundSubSubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'kitaplik')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        listing.subSubCategory?.toLowerCase() === 'kitaplik'
      )
                  ...
                  <li key={subsub.slug}>
                    <Link 
                      ...
                      className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors ${
                        subsub.slug === 'kitaplik' ? 'bg-pink-50 text-pink-700' : ''
                      }`}
                    >
