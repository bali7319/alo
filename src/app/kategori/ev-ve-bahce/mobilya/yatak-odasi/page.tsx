...
export default function YatakOdasiPage() {
  ...
  useEffect(() => {
    ...
    const foundSubSubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'yatak-odasi')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        listing.subSubCategory?.toLowerCase() === 'yatak-odasi'
      )
                  ...
                  <li key={subsub.slug}>
                    <Link 
                      ...
                      className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors ${
                        subsub.slug === 'yatak-odasi' ? 'bg-blue-50 text-blue-700' : ''
                      }`}
                    >
