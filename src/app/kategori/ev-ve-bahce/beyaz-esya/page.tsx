...
import { Refrigerator, WashingMachine, Utensils, Flame, Zap, Wind, Snowflake } from 'lucide-react'
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Beyaz Eşya Özellikleri</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center">
                  <WashingMachine className="w-4 h-4 text-green-500 mr-2" />
                  Çamaşır & Kurutma
                </li>
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  <Wind className="w-4 h-4 text-cyan-500 mr-2" />
                  Klima & Isıtıcı
                </li>
                <li className="flex items-center">
                  <Snowflake className="w-4 h-4 text-blue-400 mr-2" />
                  Soğutma Sistemleri
                </li>
              </ul>
            </div>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Buzdolabı, çamaşır makinesi, bulaşık makinesi ve diğer beyaz eşya ürünleri
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Beyaz Eşya İlanları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Beyaz Eşya İlanları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
