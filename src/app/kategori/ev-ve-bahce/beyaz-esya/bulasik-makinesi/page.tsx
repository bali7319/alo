...
import { Utensils, Droplets, Zap, Settings } from 'lucide-react'

export default function BulasikMakinesiPage() {
  ...
  // Bulaşık makinesi ilanlarını filtrele
  const bulasikMakinesiListings: Listing[] = rawListings
    .filter(listing => 
      listing.category.toLowerCase() === 'ev-ve-bahce' && 
      (listing.subCategory?.toLowerCase() ?? '') === 'beyaz-esya' &&
      listing.subSubCategory?.toLowerCase() === 'bulasik-makinesi'
    )
  ...
  useEffect(() => {
    ...
    const foundSubSubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'bulasik-makinesi')
    if (!foundSubSubcategory) return
    setSubSubcategory(foundSubSubcategory)
    
    setMappedListings(bulasikMakinesiListings)
  }, [])
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Bulaşık Makinesi Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Yüksek kapasiteli, enerji tasarruflu bulaşık makineleri
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Bulaşık Makinesi İlanları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Bulaşık Makinesi İlanları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
