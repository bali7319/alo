...
import { Snowflake, Zap, Settings } from 'lucide-react'

export default function DerinDondurucuPage() {
  ...
  // Derin dondurucu ilanlarını filtrele
  const derinDondurucuListings: Listing[] = rawListings
    .filter(listing => 
      listing.category.toLowerCase() === 'ev-ve-bahce' && 
      (listing.subCategory?.toLowerCase() ?? '') === 'beyaz-esya' &&
      listing.subSubCategory?.toLowerCase() === 'derin-dondurucu'
    )
  ...
  useEffect(() => {
    ...
    const foundSubSubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'derin-dondurucu')
    if (!foundSubSubcategory) return
    setSubSubcategory(foundSubSubcategory)
    
    setMappedListings(derinDondurucuListings)
  }, [])
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Derin Dondurucu Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Geniş hacimli, enerji tasarruflu derin dondurucular
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Derin Dondurucu İlanları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Derin Dondurucu İlanları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
