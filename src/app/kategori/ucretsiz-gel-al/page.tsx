// ucretsiz-gel-al klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Ücretsiz Gel Al';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'ucretsiz-gel-al' }, { category: 'Ücretsiz Gel Al' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/ucretsiz-gel-al`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/ucretsiz-gel-al`,
    },
  };
}

export default async function UcretsizGelAlPage() {
  const slug = 'ucretsiz-gel-al';
