...
import { Palette, Flower, Eye, Heart, Star, Sparkles, Brush } from 'lucide-react'
...
export default function KozmetikPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'kozmetik')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'kozmetik'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Kozmetik Kategorileri</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center">
                  <Brush className="w-4 h-4 text-purple-500 mr-2" />
                  Tırnak Bakımı
                </li>
                <li className="flex items-center">
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Profesyonel makyaj ürünleri, parfümler, tırnak bakım ürünleri ve daha fazlası. Güzelliğinizi ortaya çıkaracak kaliteli kozmetik ürünleri.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Kozmetik Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Kozmetik Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
