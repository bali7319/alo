...
import { Sparkles, Palette, Eye, Star, Heart, Zap, Scissors, User } from 'lucide-react'
...
export default function GuzellikMerkeziPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'guzellik-merkezi')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'güzellik merkezi'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Güzellik Merkezi Hizmetleri</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center">
                  <Palette className="w-4 h-4 text-red-500 mr-2" />
                  Makyaj & Düğün Makyajı
                </li>
                <li className="flex items-center">
                  <Eye className="w-4 h-4 text-purple-500 mr-2" />
                  Kaş & Kirpik Hizmetleri
                </li>
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  <Scissors className="w-4 h-4 text-blue-500 mr-2" />
                  Saç Bakımı & Styling
                </li>
                <li className="flex items-center">
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Profesyonel güzellik merkezi hizmetleri. Cilt bakımı, makyaj, epilasyon, masaj ve daha fazlası için uzman kadromuzla hizmetinizdeyiz.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Güzellik Merkezi Hizmetleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Güzellik Merkezi Hizmetleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
