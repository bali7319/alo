// saglik-guzellik klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Sağlık & Güzellik';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'saglik-guzellik' }, { category: 'Sağlık & Güzellik' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/saglik-guzellik`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/saglik-guzellik`,
    },
  };
}

export default async function SaglikGuzellikPage() {
  const slug = 'saglik-guzellik';
