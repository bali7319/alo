// turizm-konaklama klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Turizm & Konaklama';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'turizm-konaklama' }, { category: 'Turizm & Konaklama' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/turizm-konaklama`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/turizm-konaklama`,
    },
  };
}

export default async function TurizmKonaklamaPage() {
  const slug = 'turizm-konaklama';
