...
export default function TurizmKonaklamaPage() {
  ...
  useEffect(() => {
    // Turizm & Konaklama kategorisini bul
  ...
  const subcategoryColors: { [key: string]: string } = {
    'konaklama': 'text-blue-500',
    'turlar': 'text-green-500',
    'arac-kiralama': 'text-orange-500',
    'ucak-bileti': 'text-purple-500',
    'diger': 'text-gray-500'
  }
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="text-gray-500">Turizm & Konaklama</span>
              </div>
            </li>
          </ol>
        </nav>
              ...
              <ul className="space-y-2">
                {category.subcategories?.map((subcategory: any) => (
                  <li key={subcategory.slug}>
                    <Link 
                      href={`/kategori/turizm-konaklama/${subcategory.slug}`}
