...
import { Car, MapPin, Calendar, Star, Users, Shield } from 'lucide-react'
...
export default function AracKiralamaPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'arac-kiralama')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'arac-kiralama'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <h3 className="font-medium text-gray-900 mb-3">Araç Kiralama Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Güvenilir ve uygun fiyatlı araç kiralama seçenekleri</p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-6">Öne Çıkan Araç Kiralama</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-2xl font-semibold mb-6">En Yeni Araç Kiralama</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
