...
import { Camera, Star, MapPin, Users } from 'lucide-react'

export default function FotografcilikPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'fotografcilik')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'fotografcilik'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Fotoğrafçılık Hizmetleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Profesyonel fotoğrafçılık hizmetleri ve ekipmanları.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Fotoğrafçılık Hizmetleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Fotoğrafçılık Hizmetleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
