...
import { Palette, Star, MapPin, Users } from 'lucide-react'
...
export default function SeramikPage() {
  ...
  useEffect(() => {
    const foundCategory = categories.find((cat) => cat.slug === 'hobi-sanat')
    if (!foundCategory) return
    setCategory(foundCategory)
    
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'seramik')
    if (!foundSubcategory) return
    setSubcategory(foundSubcategory)

    // Debug: Filtreleme öncesi veri kontrolü
    console.log('Raw listings count:', rawListings.length)
    console.log('Looking for category:', 'hobi-sanat', 'subcategory:', 'seramik')
    ...
    const filtered = rawListings.filter(listing => 
      ...
      (listing.subCategory?.toLowerCase() ?? '') === 'seramik'
    )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Seramik Hizmetleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              El yapımı seramik ürünler, özel tasarımlar ve sanat eserleri.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Seramik Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Seramik Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
