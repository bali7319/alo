...
import { MoreHorizontal, Star, MapPin, Users } from 'lucide-react'
  ...
  useEffect(() => {
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'diger'
      )
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              <MoreHorizontal className="w-5 h-5 text-blue-500 mr-2" />
              Diğer Hobi Kategorileri
            </h2>
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Diğer Hobi Kategorileri</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <MoreHorizontal className="w-4 h-4 text-purple-500 mr-2" />
                  Model Yapımı
                </li>
                <li className="flex items-center">
        ...
        <main className="flex-1">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {subcategory.name} Hobi Ürünleri
            </h1>
            <p className="text-gray-600">
              Çeşitli hobi ve sanat ürünleri, malzemeler ve ekipmanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Hobi Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Hobi Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
