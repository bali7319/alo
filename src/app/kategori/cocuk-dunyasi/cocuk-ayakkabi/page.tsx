...
export default function CocukAyakkabiPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'cocuk-ayakkabi')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        listing.subCategory?.toLowerCase() === 'çocuk ayakkabı'
      )
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              <Footprints className="w-5 h-5 text-blue-500 mr-2" />
              Çocuk Ayakkabı Özellikleri
            </h2>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çocuklarınız için rahat, dayanıklı ve şık ayakkabılar. Tüm yaş grupları için uygun seçenekler.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Çocuk Ayakkabıları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Çocuk Ayakkabıları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
