...
import { Baby, Footprints, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çocuklarınızın spor aktiviteleri için rahat ve dayanıklı ayakkabılar. Koşu, futbol, basketbol ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Spor Ayakkabılar</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Spor Ayakkabılar</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
