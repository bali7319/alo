...
import { Baby, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function CocukOyuncaklariPage() {
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              <Baby className="w-5 h-5 text-orange-500 mr-2" />
              Alt Kategoriler
            </h2>
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Çocuk Oyuncakları Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çocuklarınızın gelişimini destekleyen eğitici ve eğlenceli oyuncaklar. Eğitici, peluş ve araç oyuncakları.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Çocuk Oyuncakları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Çocuk Oyuncakları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
