...
export default function PelusOyuncaklarPage() {
  ...
  useEffect(() => {
    ...
    const foundSubsubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'pelus-oyuncaklar')
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              <Gamepad2 className="w-5 h-5 text-pink-500 mr-2" />
              Peluş Oyuncaklar Özellikleri
            </h2>
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Peluş Oyuncak Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çocuklarınızın en yakın arkadaşları olacak yumuşak ve sevimli peluş oyuncaklar. Ayıcık, tavşan, köpek ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Peluş Oyuncaklar</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Peluş Oyuncaklar</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
