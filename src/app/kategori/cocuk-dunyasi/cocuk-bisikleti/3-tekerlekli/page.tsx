...
import { Baby, Bike, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function UcTekerlekliPage() {
  ...
  useEffect(() => {
    ...
    const foundSubsubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === '3-tekerlekli')
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              <Bike className="w-5 h-5 text-green-500 mr-2" />
              3 Tekerlekli Bisikletler
            </h2>
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-gray-700">
                <span className="mr-2">🚲</span>
                Pedallı 3 Tekerlekli
              </li>
              <li className="flex items-center text-gray-700">
                <span className="mr-2">🚲</span>
                Elektrikli 3 Tekerlekli
              </li>
              <li className="flex items-center text-gray-700">
                <span className="mr-2">🚲</span>
                Katlanabilir 3 Tekerlekli
              </li>
              <li className="flex items-center text-gray-700">
                <span className="mr-2">🚲</span>
                Spor 3 Tekerlekli
              ...
              <li className="flex items-center text-gray-700">
                <span className="mr-2">🚲</span>
                Özel Tasarım 3 Tekerlekli
              </li>
            </ul>

            <div className="mt-8">
              <h3 className="font-semibold mb-3">3 Tekerlekli Bisiklet Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {subsubcategory.name} Bisiklet Ürünleri
            </h1>
            <p className="text-gray-600">
              Küçük çocuklarınız için güvenli ve eğlenceli 3 tekerlekli bisikletler. Klasik, pedallı, elektrikli ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan 3 Tekerlekli Bisikletler</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni 3 Tekerlekli Bisikletler</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
