...
export default function BebekPage() {
  ...
  useEffect(() => {
    ...
    const foundSubsubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'bebek')
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Bebek Giyim Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Bebekleriniz için güvenli, yumuşak ve rahat giyim ürünleri. Tulum, çorap, eldiven ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Bebek Giyim Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Bebek Giyim Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
