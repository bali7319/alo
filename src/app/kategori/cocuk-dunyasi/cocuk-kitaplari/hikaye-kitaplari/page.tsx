...
import { Baby, BookOpen, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function HikayeKitaplariPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'cocuk-kitaplari')
    if (!foundSubcategory) return
    setSubcategory(foundSubcategory)

    const foundSubsubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'hikaye-kitaplari')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        listing.subCategory?.toLowerCase() === 'çocuk kitapları'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Hikaye Kitabı Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çocuklarınızın hayal gücünü geliştiren eğlenceli hikaye kitapları. Masallar, macera hikayeleri, fantastik hikayeler ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Hikaye Kitapları</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Hikaye Kitapları</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
