// cocuk-dunyasi klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Çocuk Dünyası';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'cocuk-dunyasi' }, { category: 'Çocuk Dünyası' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/cocuk-dunyasi`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/cocuk-dunyasi`,
    },
  };
}

export default async function CocukDunyasiPage() {
  const slug = 'cocuk-dunyasi';
