// egitim-kurslar klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Eğitim & Kurslar';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'egitim-kurslar' }, { category: 'Eğitim & Kurslar' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/egitim-kurslar`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/egitim-kurslar`,
    },
  };
}

export default async function EgitimKurslarPage() {
  const slug = 'egitim-kurslar';
