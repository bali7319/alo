...
import { Calculator, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function MuhasebeciFinansElemaniPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'muhasebeci-finans-elemani')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Muhasebeci / Finans Elemanı'
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              ...
              Muhasebeci / Finans Elemanı Özellikleri
            </h2>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Şirketler için deneyimli muhasebeci ve finans elemanı aranıyor. Mali işler ve finansal raporlama konularında uzman.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Muhasebeci / Finans Elemanı İlanları</h2>
            <FeaturedAds 
              category="İş"
              subcategory="Muhasebeci / Finans Elemanı"
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Muhasebeci / Finans Elemanı İlanları</h2>
            <LatestAds 
              category="İş"
              subcategory="Muhasebeci / Finans Elemanı"
              listings={mappedListings} 
