...
import { GraduationCap, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function OgretmenEgitmenPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'ogretmen-egitmen')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Öğretmen / Eğitmen'
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Okul, kurs ve özel dersler için deneyimli öğretmen ve eğitmen aranıyor. Alanında uzman, öğrenci odaklı çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Öğretmen / Eğitmen İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Öğretmen / Eğitmen" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Öğretmen / Eğitmen İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Öğretmen / Eğitmen" 
              listings={mappedListings} 
