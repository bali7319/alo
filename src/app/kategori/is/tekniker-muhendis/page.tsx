...
import { Wrench, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function TeknikerMuhendisPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'tekniker-muhendis')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Tekniker / Mühendis'
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Şirketler için deneyimli tekniker ve mühendis aranıyor. Alanında uzman, analitik düşünebilen kişiler.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Tekniker / Mühendis İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Tekniker / Mühendis" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Tekniker / Mühendis İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Tekniker / Mühendis" 
              listings={mappedListings} 
