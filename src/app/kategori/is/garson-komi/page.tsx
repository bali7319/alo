...
import { Utensils, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function GarsonKomiPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'garson-komi')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Garson / Komi'
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Restoran ve kafeler için deneyimli garson ve komi personeli aranıyor. Müşteri memnuniyeti odaklı çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Garson / Komi İlanları</h2>
            <FeaturedAds 
              category="İş"
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Garson / Komi İlanları</h2>
            <LatestAds 
              category="İş"
              subcategory="Garson / Komi"
              listings={mappedListings} 
