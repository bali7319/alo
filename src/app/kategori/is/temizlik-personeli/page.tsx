...
import { Sparkles, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function TemizlikPersoneliPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'temizlik-personeli')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Temizlik Personeli'
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              ...
              Temizlik Personeli Özellikleri
            </h2>
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Ev, ofis ve işyerleri için güvenilir temizlik personeli aranıyor. Deneyimli ve dikkatli çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Temizlik Personeli İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Temizlik Personeli" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Temizlik Personeli İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Temizlik Personeli" 
              listings={mappedListings} 
