...
import { Stethoscope, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function SaglikPersoneliPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'saglik-personeli')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Sağlık Personeli'
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Hastane, klinik ve evde bakım için deneyimli sağlık personeli aranıyor. Alanında uzman, sabırlı çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Sağlık Personeli İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Sağlık Personeli" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Sağlık Personeli İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Sağlık Personeli" 
              listings={mappedListings} 
