...
import { ShoppingCart, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function SatisDanismaniPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'satis-danismani')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Satış Danışmanı'
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Mağaza ve showroom'lar için deneyimli satış danışmanı aranıyor. Müşteri memnuniyeti odaklı çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Satış Danışmanı İlanları</h2>
            <FeaturedAds 
              category="İş"
              subcategory="Satış Danışmanı"
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Satış Danışmanı İlanları</h2>
            <LatestAds 
              category="İş"
              subcategory="Satış Danışmanı"
              listings={mappedListings} 
