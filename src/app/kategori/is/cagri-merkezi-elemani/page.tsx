...
import { Phone, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function CagriMerkeziElemaniPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'cagri-merkezi-elemani')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Çağrı Merkezi Elemanı'
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Çağrı merkezleri için deneyimli eleman aranıyor. İletişim becerisi yüksek, müşteri odaklı çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Çağrı Merkezi Elemanı İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Çağrı Merkezi Elemanı" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Çağrı Merkezi Elemanı İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Çağrı Merkezi Elemanı" 
              listings={mappedListings} 
