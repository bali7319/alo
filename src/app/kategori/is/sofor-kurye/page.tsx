...
import { Car, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function SoforKuryePage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'sofor-kurye')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Şoför / Kurye'
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Kargo ve teslimat şirketleri için deneyimli şoför ve kurye personeli aranıyor. Güvenli ve hızlı teslimat.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Şoför / Kurye İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Şoför / Kurye" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Şoför / Kurye İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Şoför / Kurye" 
              listings={mappedListings} 
