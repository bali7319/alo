...
import { Shield, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function GuvenlikGorevlisiPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'guvenlik-gorevlisi')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Güvenlik Görevlisi'
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              ...
              Güvenlik Görevlisi Özellikleri
            </h2>
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Site, ofis ve AVM'ler için deneyimli güvenlik görevlisi aranıyor. Dikkatli ve güvenilir çalışanlar.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Güvenlik Görevlisi İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Güvenlik Görevlisi" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Güvenlik Görevlisi İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Güvenlik Görevlisi" 
              listings={mappedListings} 
