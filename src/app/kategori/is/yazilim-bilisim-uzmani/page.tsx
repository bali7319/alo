...
import { Laptop, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function YazilimBilisimUzmaniPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'yazilim-bilisim-uzmani')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Yazılım / Bilişim Uzmanı'
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              ...
              Yazılım / Bilişim Uzmanı Özellikleri
            </h2>
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Yazılım ve bilişim alanında deneyimli uzmanlar aranıyor. Takım çalışmasına yatkın, analitik düşünebilen kişiler.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Yazılım / Bilişim Uzmanı İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Yazılım / Bilişim Uzmanı" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Yazılım / Bilişim Uzmanı İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Yazılım / Bilişim Uzmanı" 
              listings={mappedListings} 
