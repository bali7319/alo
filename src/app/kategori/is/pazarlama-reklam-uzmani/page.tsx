...
import { Megaphone, Star, Heart, Users, Zap, Award, Clock, MapPin } from 'lucide-react'

export default function PazarlamaReklamUzmaniPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'pazarlama-reklam-uzmani')
    ...
    const filtered = rawListings.filter(listing => {
      ...
      const subcategoryMatch = listing.subCategory === 'Pazarlama / Reklam Uzmanı'
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center">
              ...
              Pazarlama / Reklam Uzmanı Özellikleri
            </h2>
        ...
        <main className="flex-1">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Şirketler için deneyimli pazarlama ve reklam uzmanı aranıyor. Yaratıcı, iletişim becerisi yüksek kişiler.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Pazarlama / Reklam Uzmanı İlanları</h2>
            <FeaturedAds 
              category="İş" 
              subcategory="Pazarlama / Reklam Uzmanı" 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Pazarlama / Reklam Uzmanı İlanları</h2>
            <LatestAds 
              category="İş" 
              subcategory="Pazarlama / Reklam Uzmanı" 
              listings={mappedListings} 
