...
export default function ModaStilPage() {
  ...
  const subcategoryColors: { [key: string]: string } = {
    'kadin': 'text-pink-500',
    'erkek': 'text-blue-500',
    'cocuk': 'text-purple-500',
    'ayakkabi': 'text-orange-500',
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="text-gray-500">Moda & Stil</span>
              </div>
            </li>
          </ol>
        </nav>
              ...
              <ul className="space-y-2">
                {category.subcategories?.map((subcategory: any) => (
                  <li key={subcategory.slug}>
                    <Link 
                      href={`/kategori/moda-stil/${subcategory.slug}`}
