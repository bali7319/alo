// moda-stil klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Moda & Stil';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'moda-stil' }, { category: 'Moda & Stil' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/moda-stil`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/moda-stil`,
    },
  };
}

export default async function ModaStilPage() {
  const slug = 'moda-stil';
