...
export default function CocukAyakkabiPage() {
  ...
  useEffect(() => {
    ...
    const foundSubsubcategory = foundSubcategory.subcategories?.find((subsub) => subsub.slug === 'cocuk-ayakkabi')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        listing.subSubCategory?.toLowerCase() === 'cocuk-ayakkabi'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <li key={subsub.slug}>
                  <Link 
                    ...
                    className={`flex items-center text-gray-700 hover:text-orange-600 transition-colors ${
                      subsub.slug === 'cocuk-ayakkabi' ? 'text-orange-600 font-semibold' : ''
                    }`}
                  >
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Çocuk Ayakkabı Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Sağlıklı ve rahat çocuk ayakkabı modelleri ile çocuklarınızın ayak sağlığını koruyun. Okul, spor ve günlük kullanım için.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Çocuk Ayakkabı Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Çocuk Ayakkabı Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
