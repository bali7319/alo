...
import { Gem, Star, Heart, Users, Zap, Award, Clock, MapPin, Sparkles } from 'lucide-react'
...
export default function AksesuarPage() {
  ...
  useEffect(() => {
    ...
    const foundSubcategory = foundCategory.subcategories?.find((sub) => sub.slug === 'aksesuar')
    ...
    const mapped = rawListings
      .filter(listing => 
        ...
        (listing.subCategory?.toLowerCase() ?? '') === 'aksesuar'
      )
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8">
              <h3 className="font-semibold mb-3">Aksesuar Özellikleri</h3>
        ...
        <main className="flex-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Şık ve kaliteli aksesuar ürünleri ile tarzınızı tamamlayın. Çanta, takı, saat, gözlük ve daha fazlası.
            </p>
          </div>

          {/* Featured Ads */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Öne Çıkan Aksesuar Ürünleri</h2>
            <FeaturedAds 
          ...
          {/* Latest Ads */}
          <div>
            <h2 className="text-xl font-semibold mb-4">En Yeni Aksesuar Ürünleri</h2>
            <LatestAds 
              category={category.slug} 
              subcategory={subcategory.slug} 
              listings={mappedListings} 
