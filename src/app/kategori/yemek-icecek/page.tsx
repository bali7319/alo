// yemek-icecek klasörü dinamik route'u bloke ediyor
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const categoryName = 'Yemek & İçecek';
  let listingCount = 0;
  try {
    listingCount = await withTimeout(
      prisma.listing.count({
        where: {
          OR: [{ category: 'yemek-icecek' }, { category: 'Yemek & İçecek' }],
          isActive: true,
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://alo17.tr/kategori/yemek-icecek`,
      siteName: 'Alo17',
      locale: 'tr_TR',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `https://alo17.tr/kategori/yemek-icecek`,
    },
  };
}

export default async function YemekIcecekPage() {
  const slug = 'yemek-icecek';
