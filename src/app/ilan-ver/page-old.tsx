...
export default function IlanVerPage() {
  ...
  const premiumFeatures = [
    ...
    },
    {
      ...
      description: 'İlanınız otomatik olarak sosyal medyada paylaşılır',
      price: 40,
      icon: Eye
    },
    {
      ...
      description: 'İlanınızın görüntülenme ve etkileşim verilerini takip edin',
      price: 35,
      icon: TrendingUp
    },
    {
    ...
    },
    {
      id: 'customBadge',
      name: 'Özel Rozet',
      description: 'İlanınıza özel tasarım rozeti ekleyin',
      price: 45,
      icon: Crown
    },
    {
      id: 'videoUpload',
      name: 'Video Yükleme',
      description: 'İlanınıza video ekleyin (max 30 saniye)',
      price: 55,
      icon: Camera
    },
    {
      id: 'multipleContacts',
      name: 'Çoklu İletişim',
      description: 'Birden fazla telefon numarası ve sosyal medya ekleyin',
      price: 20,
      icon: Plus
    }
  ];
