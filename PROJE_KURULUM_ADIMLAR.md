...
- ✅ Fail2ban aktif
- ✅ Firewall aktif (22, 80, 443 portları açık)
...
**VEYA WinSCP ile (ÖNERİLEN):**
- WinSCP'yi açın
- Sol: `C:\Users\bali\Desktop\alo`
- Sağ: `/var/www/alo17`
- Tüm klasörleri sürükle-bırak (node_modules ve .next hariç)

### 4. Sunucuda Dosyaları Kontrol Et
...
### 6. PostgreSQL Veritabanı Oluştur
...
### 7. Bağımlılıkları Kur ve Build Et
